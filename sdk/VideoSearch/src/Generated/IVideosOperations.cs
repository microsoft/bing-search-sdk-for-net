...
namespace Microsoft.Bing.VideoSearch
{
    ...
    {
        /// <summary>
        /// The Video Search API lets you send a search query to Bing and get
        /// back a list of videos that are relevant to the search query. This
        /// section provides technical details about the query parameters and
        /// headers that you use to request videos and the JSON response
        /// objects that contain them. For examples that show how to make
        ...
        /// Use this parameter only with the Video Search API. Do not specify
        ...
        /// This header and the
        /// [setLang](https://docs.microsoft.com/en-us/bing/bing-video-search/overview)
        /// query parameter are mutually exclusive; do not specify both. If you
        /// set this header, you must also specify the
        /// [cc](https://docs.microsoft.com/en-us/bing/bing-video-search/overview)
        ...
        /// use the
        /// [mkt](https://docs.microsoft.com/en-us/bing/bing-video-search/overview)
        /// and
        /// [setLang](https://docs.microsoft.com/en-us/bing/bing-video-search/overview)
        ...
        /// maximum is 105. You may use this parameter along with the offset
        ...
        /// the Video Search API. Do not specify this parameter when calling
        /// the Trending Videos API or the Web Search API.
        /// </param>
        /// <param name='freshness'>
        /// Filter videos by the date and time that Bing discovered the video.
        /// The following are the possible filter values. Day: Return videos
        /// discovered within the last 24 hours. Week: Return videos discovered
        /// within the last 7 days. Month: Return videos discovered within the
        /// last 30 days. Possible values include: 'Day', 'Week', 'Month'
        /// </param>
        /// <param name='id'>
        /// An ID that uniquely identifies a video. The
        /// [Video](https://docs.microsoft.com/en-us/bing/bing-video-search/overview)
        /// object's videoId field contains the ID that you set this parameter
        /// to. You use this parameter to ensure that the specified video is
        /// the first video in the list of videos that Bing returns.
        /// </param>
        /// <param name='length'>
        /// Filter videos by the following lengths: Short: Return videos that
        /// are less than 5 minutes. Medium: Return videos that are between 5
        /// and 20 minutes, inclusive. Long: Return videos that are longer than
        /// 20 minutes. All: Do not filter by length.Specifying this value is
        /// the same as not specifying the videoLength parameter. Possible
        /// values include: 'All', 'Short', 'Medium', 'Long'
        /// </param>
        /// <param name='market'>
        ...
        /// see [Market
        /// Codes](https://docs.microsoft.com/en-us/bing/bing-video-search/overview).
        ...
        /// </param>
        /// <param name='offset'>
        /// The zero-based offset that indicates the number of videos to skip
        /// before returning videos. The default is 0. The offset should be
        /// less than
        ...
        /// [nextOffset](https://docs.microsoft.com/en-us/bing/bing-video-search/overview).
        /// Use this parameter only with the Video Search API.
        /// </param>
        /// <param name='pricing'>
        /// Filter videos by the following pricing options: Free: Return videos
        /// that are free to view. Paid: Return videos that require a
        /// subscription or payment to view. All: Do not filter by
        ...
        /// Filter videos by the following resolutions: SD480p: Return videos
        /// with a 480p or higher resolution. HD720p: Return videos with a 720p
        /// or higher resolution. HD1080p: Return videos with a 1080p or higher
        /// resolution. All: Do not filter by resolution.Specifying this value
        /// is the same as not specifying the resolution parameter. Possible
        /// values include: 'All', 'SD480p', 'HD720p', 'HD1080p'
        /// </param>
        /// <param name='safeSearch'>
        /// Filter videos for adult content. The following are the possible
        /// filter values. Off: If the request is through the Video Search API,
        /// the response includes adult videos and the thumbnail images of the
        /// videos are clear (non-fuzzy). If the request is through the Web
        /// Search API, the response includes adult videos but the thumbnail
        /// images of the videos are pixelated (fuzzy). Moderate: If the
        /// request is through the Video Search API, the response does not
        /// include videos with adult content. If the request is through the
        /// Web Search API, the response may include videos with adult content
        /// but the thumbnail images of the videos are pixelated (fuzzy).
        ...
        /// [Accept-Language](https://docs.microsoft.com/en-us/bing/bing-video-search/overview)
        ...
        /// decoration markers such as hit highlighting characters. If true,
        /// the strings may include markers. The default is false. To specify
        /// whether to use Unicode characters or HTML tags as the markers, see
        /// the
        /// [textFormat](https://docs.microsoft.com/en-us/bing/bing-video-search/overview)
        ...
        /// [Video](https://docs.microsoft.com/en-us/bing/bing-video-search/overview)
        /// object's videoId field contains the ID that you set this parameter
        /// to. You use this parameter to identify the video to get insights
        /// of.
        /// </param>
        /// <param name='modules'>
        /// A comma-delimited list of insights to request. The following are
        /// the possible case-insensitive values. All: Return all available
        /// insights. RelatedVideos: Return a list of videos that are similar
        /// to the video specified by the id query parameter. VideoResult:
        /// Return the video that you're requesting insights of (this is the
        /// video that you set the id query parameter to in your insights
        /// request). If you specify an insight and there is no data for it,
        /// the response object does not include the related field. For
        /// example, if you specify RelatedVideos and none exist, the response
        /// does not include the relatedVideos field. Although the user's query
        /// term is not required, you should always include it because it helps
        /// to improve relevance and the results.
        /// </param>
        /// <param name='market'>
        /// The market where the results come from. Typically, mkt is the
        /// country where the user is making the request from. However, it

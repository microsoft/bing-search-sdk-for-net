...
namespace Microsoft.Bing.VideoSearch.Models
{
    ...
    public partial class TrendingVideos : Response
    {
        ...
        /// item.</param>
        public TrendingVideos(IList<TrendingVideosTile> bannerTiles, IList<TrendingVideosCategory> categories, string _type = default(string), string id = default(string), string webSearchUrl = default(string))

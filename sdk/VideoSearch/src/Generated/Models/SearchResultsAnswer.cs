...
namespace Microsoft.Bing.VideoSearch.Models
{
    ...
    public partial class SearchResultsAnswer : Answer
    {
        ...
        public SearchResultsAnswer(string _type = default(string), string id = default(string), string webSearchUrl = default(string), IList<Query> followUpQueries = default(IList<Query>), long? totalEstimatedMatches = default(long?), bool? isFamilyFriendly = default(bool?))

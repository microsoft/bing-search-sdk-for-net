...
namespace Microsoft.Bing.ImageSearch
{
    ...
    public static partial class ImagesOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ImageInsights> DetailsAsync(this IImagesOperations operations, string query, string acceptLanguage = default(string), string contentType = default(string), string userAgent = default(string), string clientId = default(string), string clientIp = default(string), string location = default(string), double? cropBottom = default(double?), double? cropLeft = default(double?), double? cropRight = default(double?), double? cropTop = default(double?), string cropType = default(string), string countryCode = default(string), string id = default(string), string imageUrl = default(string), string insightsToken = default(string), IList<string> modules = default(IList<string>), string market = default(string), string safeSearch = default(string), string setLang = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.DetailsWithHttpMessagesAsync(query, acceptLanguage, contentType, userAgent, clientId, clientIp, location, cropBottom, cropLeft, cropRight, cropTop, cropType, countryCode, id, imageUrl, insightsToken, modules, market, safeSearch, setLang, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TrendingImages> TrendingAsync(this IImagesOperations operations, string acceptLanguage = default(string), string userAgent = default(string), string clientId = default(string), string clientIp = default(string), string location = default(string), string countryCode = default(string), string market = default(string), string safeSearch = default(string), string setLang = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.TrendingWithHttpMessagesAsync(acceptLanguage, userAgent, clientId, clientIp, location, countryCode, market, safeSearch, setLang, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }

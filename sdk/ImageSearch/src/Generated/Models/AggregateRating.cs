...
namespace Microsoft.Bing.ImageSearch.Models
{
    ...
    public partial class AggregateRating : Rating
    {
        ...
        public AggregateRating(double ratingValue, string text = default(string), string _type = default(string), double? bestRating = default(double?), int? reviewCount = default(int?))
            : base(ratingValue, text, _type, bestRating)
        {

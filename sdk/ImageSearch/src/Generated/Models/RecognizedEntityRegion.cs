...
namespace Microsoft.Bing.ImageSearch.Models
{
    ...
    public partial class RecognizedEntityRegion : Response
    {
        ...
        public RecognizedEntityRegion(string _type = default(string), string id = default(string), string readLink = default(string), string webSearchUrl = default(string), NormalizedRectangle region = default(NormalizedRectangle), IList<RecognizedEntity> matchingEntities = default(IList<RecognizedEntity>))

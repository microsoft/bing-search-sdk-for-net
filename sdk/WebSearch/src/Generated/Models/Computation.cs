...
namespace Microsoft.Bing.WebSearch.Models
{
    ...
    public partial class Computation : Answer
    {
        ...
        /// item.</param>
        public Computation(string expression, string value, string _type = default(string), string id = default(string), string webSearchUrl = default(string), IList<Query> followUpQueries = default(IList<Query>))

...
namespace Microsoft.Bing.WebSearch.Models
{
    ...
    public partial class Thing : Response
    {
        ...
        /// item.</param>
        public Thing(string _type = default(string), string id = default(string), string webSearchUrl = default(string), string name = default(string), string url = default(string), ImageObject image = default(ImageObject), string description = default(string), string bingId = default(string))

...
namespace Microsoft.Bing.WebSearch.Models
{
    ...
    public partial class Places : SearchResultsAnswer
    {
        ...
        public Places(IList<Thing> value, string _type = default(string), string id = default(string), string webSearchUrl = default(string), IList<Query> followUpQueries = default(IList<Query>), QueryContext queryContext = default(QueryContext), long? totalEstimatedMatches = default(long?), bool? isFamilyFriendly = default(bool?))

...
namespace Microsoft.Bing.WebSearch.Models
{
    ...
    public partial class StructuredValue : Intangible
    {
        ...
        /// item.</param>
        public StructuredValue(string _type = default(string), string id = default(string), string webSearchUrl = default(string), string name = default(string), string url = default(string), ImageObject image = default(ImageObject), string description = default(string), string bingId = default(string))
            : base(_type, id, webSearchUrl, name, url, image, description, bingId)
        {
            CustomInit();
        }

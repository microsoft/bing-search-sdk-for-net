...
namespace Microsoft.Bing.WebSearch.Models
{
    ...
    public partial class SpellSuggestions : SearchResultsAnswer
    {
        ...
        public SpellSuggestions(IList<Query> value, string _type = default(string), string id = default(string), string webSearchUrl = default(string), IList<Query> followUpQueries = default(IList<Query>), QueryContext queryContext = default(QueryContext), long? totalEstimatedMatches = default(long?), bool? isFamilyFriendly = default(bool?))
            : base(_type, id, webSearchUrl, followUpQueries, queryContext, totalEstimatedMatches, isFamilyFriendly)
        {
            Value = value;
            CustomInit();
        }

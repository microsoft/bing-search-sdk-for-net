...
namespace Microsoft.Bing.EntitySearch.Models
{
    ...
    public partial class Response : Identifiable
    {
        ...
        /// item.</param>
        public Response(string _type = default(string), string id = default(string), IList<ContractualRulesContractualRule> contractualRules = default(IList<ContractualRulesContractualRule>), string webSearchUrl = default(string))
            : base(_type, id)
        {

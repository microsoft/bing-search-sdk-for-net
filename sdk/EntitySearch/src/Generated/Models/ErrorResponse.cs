...
namespace Microsoft.Bing.EntitySearch.Models
{
    ...
    public partial class ErrorResponse : Response
    {
        ...
        /// item.</param>
        public ErrorResponse(IList<Error> errors, string _type = default(string), string id = default(string), IList<ContractualRulesContractualRule> contractualRules = default(IList<ContractualRulesContractualRule>), string webSearchUrl = default(string))

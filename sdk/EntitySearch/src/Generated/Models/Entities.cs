...
namespace Microsoft.Bing.EntitySearch.Models
{
    ...
    public partial class Entities : SearchResultsAnswer
    {
        ...
        /// 'ListWithPivot'</param>
        public Entities(IList<Thing> value, string _type = default(string), string id = default(string), IList<ContractualRulesContractualRule> contractualRules = default(IList<ContractualRulesContractualRule>), string webSearchUrl = default(string), QueryContext queryContext = default(QueryContext), string queryScenario = default(string))

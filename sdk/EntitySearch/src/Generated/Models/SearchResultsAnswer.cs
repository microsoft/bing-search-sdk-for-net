...
namespace Microsoft.Bing.EntitySearch.Models
{
    ...
    public partial class SearchResultsAnswer : Answer
    {
        ...
        /// item.</param>
        public SearchResultsAnswer(string _type = default(string), string id = default(string), IList<ContractualRulesContractualRule> contractualRules = default(IList<ContractualRulesContractualRule>), string webSearchUrl = default(string), QueryContext queryContext = default(QueryContext))

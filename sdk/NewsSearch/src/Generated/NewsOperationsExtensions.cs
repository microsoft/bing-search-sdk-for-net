...
namespace Microsoft.Bing.NewsSearch
{
    ...
    public static partial class NewsOperationsExtensions
    {
            ...
            /// [cc](https://docs.microsoft.com/en-us/bing/bing-news-search/overview) query
            ...
            /// <summary>
            /// The News Category API lets you search on Bing and get back a list of top
            /// news articles by category. This section provides technical details about
            /// the query parameters and headers that you use to request news and the JSON
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<TrendingTopics> TrendingAsync(this INewsOperations operations, string acceptLanguage = default(string), string userAgent = default(string), string clientId = default(string), string clientIp = default(string), string location = default(string), string countryCode = default(string), int? count = default(int?), string market = default(string), int? offset = default(int?), string safeSearch = default(string), string setLang = default(string), long? since = default(long?), string sortBy = default(string), bool? textDecorations = default(bool?), string textFormat = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.TrendingWithHttpMessagesAsync(acceptLanguage, userAgent, clientId, clientIp, location, countryCode, count, market, offset, safeSearch, setLang, since, sortBy, textDecorations, textFormat, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }

...
namespace Microsoft.Bing.NewsSearch.Models
{
    ...
    public partial class Organization : Thing
    {
        ...
        /// item.</param>
        public Organization(string _type = default(string), string id = default(string), string webSearchUrl = default(string), string name = default(string), string url = default(string), ImageObject image = default(ImageObject), string description = default(string), string alternateName = default(string), string bingId = default(string))
            : base(_type, id, webSearchUrl, name, url, image, description, alternateName, bingId)
        {
            CustomInit();
        }

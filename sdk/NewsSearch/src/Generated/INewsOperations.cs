...
namespace Microsoft.Bing.NewsSearch
{
    ...
    {
        /// <summary>
        /// The News Search API lets you send a search query to Bing and get
        /// back a list of news that are relevant to the search query. This
        /// section provides technical details about the query parameters and
        /// headers that you use to request news and the JSON response objects
        /// that contain them.  For examples that show how to make requests,
        /// see [Searching the web for
        ...
        /// this parameter when calling the Trending Topics API or News
        /// Category API.
        /// </param>
        ...
        /// This header and the
        /// [setLang](https://docs.microsoft.com/en-us/bing/bing-news-search/overview)
        /// query parameter are mutually exclusive; do not specify both. If you
        /// set this header, you must also specify the
        /// [cc](https://docs.microsoft.com/en-us/bing/bing-news-search/overview)
        ...
        /// use the
        /// [mkt](https://docs.microsoft.com/en-us/bing/bing-news-search/overview)
        /// and
        /// [setLang](https://docs.microsoft.com/en-us/bing/bing-news-search/overview)
        ...
        /// not specify this parameter when calling the News Category API or
        /// the Trending Topics API. Possible values include: 'Day', 'Week',
        /// 'Month'
        /// </param>
        /// <param name='market'>
        ...
        /// see [Market
        /// Codes](https://docs.microsoft.com/en-us/bing/bing-news-search/overview).
        ...
        /// Filter news for adult content. The following are the possible
        /// filter values. Off: Return news articles with adult text, images,
        /// or videos. Moderate: Return news articles with adult text but not
        /// adult images or videos. Strict: Do not return news articles with
        /// adult text, images, or videos. If the request comes from a market
        /// that Bing's adult policy requires that safeSearch is set to Strict,
        /// Bing ignores the safeSearch value and uses Strict. If you use the
        /// site: query operator, there is the chance that the response may
        ...
        /// [Accept-Language](https://docs.microsoft.com/en-us/bing/bing-news-search/overview)
        ...
        /// the
        /// [textFormat](https://docs.microsoft.com/en-us/bing/bing-news-search/overview)
        ...
        /// request news and the JSON response objects that contain them.  For
        ...
        /// Entertainment articles. For a list of possible categories, see
        /// [News Categories by
        /// Market](https://docs.microsoft.com/en-us/bing/bing-news-search/overview).
        /// Use this parameter only with News Category API. If you do not
        /// specify this parameter, the response includes both: Headline
        /// articles typically published in the last 24 hours from any category
        /// and articles from each parent category (up to four articles). If
        /// the article is a headline, the article's headline field is set to
        /// true. By default, the response includes up to 12 headline articles.
        /// To specify the number of headline articles to return, set the
        /// [headlineCount](https://docs.microsoft.com/en-us/bing/bing-news-search/overview)
        /// query parameter.
        /// </param>
        /// <param name='count'>
        /// The number of news articles to return in the response. The actual
        ...
        /// [category](https://docs.microsoft.com/en-us/bing/bing-news-search/overview)
        ...
        /// default is 12. Specify this parameter only if you do not specify
        /// the
        /// [category](https://docs.microsoft.com/en-us/bing/bing-news-search/overview)
        /// parameter.
        /// </param>
        ...
        /// trending topics. Bing returns trending topics that it discovered on
        /// or after the specified date and time, not the date the topic was
        /// published. To use this parameter, also specify the sortBy
        /// parameter. Use this parameter only with the News Trending Topics
        /// API. Do not specify this parameter when calling the News Search API
        /// or News Category API.
        /// </param>
        /// <param name='sortBy'>
        /// The order to return the news in. The following are the possible
